...
class Consumer {
    ...
    on(event, cb) {
        ...
        if (event === 'message') {
            ...
            if (!((_d = this.connection.brokerManager) === null || _d === void 0 ? void 0 : _d.isClosed())) {
                (_e = this.connection.brokerConnection) === null || _e === void 0 ? void 0 : _e.pullSubscribe(`${subject}.final`, {
                    mack: true,
                    config: {
